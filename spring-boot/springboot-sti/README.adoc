...
----
oc create -f oc create -f https://raw.githubusercontent.com/tecong/springboot-on-openshift-examples/master/spring-boot/springboot-sti/springboot-sti-all.json
----
